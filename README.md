...
| [`feature-implementation`](skills/feature-implementation/) | Implement an approved feature through coherent, verified slices with safe parallel delegation and explicit integration ownership. |
